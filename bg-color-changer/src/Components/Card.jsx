...
function Card(props){
    return (<>
            <div className="flex font-sans bg-white-400">
  <div className="flex-none w-56 relative">
    <img src={props.src} alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
  </div>
  <form className="flex-auto p-6">
    ...
    <div className="flex space-x-4 mb-5 text-sm font-medium">
      <div className="flex-auto flex space-x-4">
        ...
        <button className="h-10 px-6 font-semibold rounded-full bg-violet-600 text-white" type="button">
          Add to bag
        </button>
      </div>
