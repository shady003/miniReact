  ...
  return (
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                ...
                                <Link to="#" title="" className="text-sm font-medium text-blue-600 hover:underline hover:text-blue-700 focus:text-blue-700"> Forgot password? </Link>
                            </div>
                            <div className="mt-2.5">
                                <input
                                    type="password"
        ...
        <div className="flex items-center justify-center px-4 py-10 sm:py-16 lg:py-24 bg-gray-50 sm:px-6 lg:px-8">
            <div>
                <img className="w-full mx-auto" src="https://thebetterkashmir.com/betterkashmircontent/uploads/2022/05/unnamed.png" alt="" />

                <div className="w-full max-w-md mx-auto xl:max-w-xl">
                    <h3 className="text-2xl font-bold text-center text-black">Welcome Back Dear </h3>
