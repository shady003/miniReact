            ...
            <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                <div className="overflow-hidden bg-white rounded-xl">
                    <div className="p-6">
                        ...
                        <p className="mt-6 text-lg font-medium text-gray-900">+91-9140071837</p>
                        <p className="mt-1 text-lg font-medium text-gray-900">+91-8004481888</p>
                    </div>
                </div>
                ...
                <div className="overflow-hidden bg-white rounded-xl">
                    <div className="p-6">
                        ...
                        <p className="mt-6 text-lg font-medium text-gray-900">saurabhyadav9909@gmail.com</p>
                        <p className="mt-1 text-lg font-medium text-gray-900">doon.com</p>
                    </div>
                </div>
                ...
                <div className="overflow-hidden bg-white rounded-xl">
                    <div className="p-6">
                        ...
                        <p className="mt-6 text-lg font-medium leading-relaxed text-gray-900"> New Delhi, INDIA</p>
                    </div>
                </div>
            </div>
                    ...
                    <form action="#" method="POST" className="mt-14">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                            ...
                            <div>
                                ...
                                <div className="mt-2.5 relative">
                                    <input type="phone" name="" id="" placeholder="Enter your full name" className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                                </div>
                            </div>
